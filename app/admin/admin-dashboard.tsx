...
// Tambahkan import untuk AlertDialog dan komponennya
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
// Tambahkan import untuk NotificationSettings
...
// Tambahkan interface untuk statistik
interface UserStats {
  totalUsers: number
  premiumUsers: number
  freeUsers: number
...
// Ubah interface AdminDashboardProps untuk menambahkan tipe data yang lebih lengkap
...
export default function AdminDashboard({ initialUsers }: AdminDashboardProps) {
  ...
  // Tambahkan state untuk dialog hapus akun
        ...
        <Card className="bg-white border-2 border-black shadow-[var(--shadow)]">
          <CardContent className="p-6">
            ...
            <div className="mt-4 pt-4 border-t flex justify-between items-center">
              ...
              <Button variant="ghost" size="sm" className="h-7 text-xs" onClick={refreshUsers}>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-md p-3 flex items-start gap-2">
                  ...
                  <div className="text-sm text-amber-800">
                    ...
                    <p className="text-xs mt-1">
                      Anda dapat mengubah status premium pengguna atau menghapus akun pengguna dengan mengklik tombol
                      pada kolom Aksi.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-md p-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-700 mt-1">
                    Untuk pengaturan lebih lengkap dan melihat riwayat transaksi, silakan kunjungi halaman admin
                    premium.
                  </p>
