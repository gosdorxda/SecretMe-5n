        ...
        <CardContent className="p-0">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="bg-gradient-to-br from-[var(--bg)] to-gray-100 md:w-1/3">
              ...
              <motion.div
                className="bg-white p-3 rounded-md border-2 border-[var(--border)] mb-3 mx-4"
                whileHover={{ scale: 1.02 }}
                transition={{ duration: 0.2 }}
              >
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-gray-500">Link profil:</span>
                  <code className="bg-gray-100 px-2 py-1 rounded text-xs flex-1 truncate">{profileUrl}</code>
                </div>
              </motion.div>
              ...
              <div className="mx-4 mb-4">
                <Button
                  variant="secondary"
                  size="sm"
                  className="w-full text-xs h-9 bg-gray-50 border border-gray-200 hover:bg-gray-100 transition-colors"
                >
                  <ProfileImageButton
